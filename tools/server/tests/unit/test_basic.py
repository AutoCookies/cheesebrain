...
server = ServerPreset.tinycheese2()
...
def test_load_split_model():
    ...
    server.model_hf_file = "tinycheeses/split/stories15M-q8_0-00001-of-00003.gguf"
    server.model_alias = "tinycheese-split"
    server.start()
...
def test_server_model_aliases_and_tags():
    global server
    server.model_alias = "tinycheese-2,fim,code"
    ...
    assert set(model["aliases"]) == {"tinycheese-2", "fim", "code"}
